...
describe('Error Coverage Validation', () => {
  ...
  it('should have string keys for all ECIES error types', () => {
    ...
    errorTypes.forEach((errorType) => {
      ...
      expect(hasKey).toBe(
        true,
        `Missing string key for ECIES error: ${errorType}`,
      );
    });
  });
  ...
  it('should have string keys for all Member error types', () => {
    ...
    errorTypes.forEach((errorType) => {
      ...
      expect(hasKey).toBe(
        true,
        `Missing string key for Member error: ${errorType}`,
      );
    });
  });
  ...
  it('should have string keys for all Length error types', () => {
    ...
    errorTypes.forEach((errorType) => {
      ...
      expect(hasKey).toBe(
        true,
        `Missing string key for Length error: ${errorType}`,
      );
    });
  });
  ...
  it('should have string keys for all PBKDF2 error types', () => {
    ...
    errorTypes.forEach((errorType) => {
      ...
      expect(hasKey).toBe(
        true,
        `Missing string key for PBKDF2 error: ${errorType}`,
      );
    });
  });
  ...
  it('should have string keys for all SecureStorage error types', () => {
    ...
    errorTypes.forEach((errorType) => {
      ...
      expect(hasKey).toBe(
        true,
        `Missing string key for SecureStorage error: ${errorType}`,
      );
    });
  });
