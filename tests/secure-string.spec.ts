...
describe('SecureString', () => {
  ...
  describe('getters', () => {
    ...
    it('should return the correct value as buffer', () => {
      expect(new TextDecoder().decode(secureString.valueAsUint8Array)).toBe(
        testString,
      );
    });
  ...
  describe('Uint8Array operations', () => {
    ...
    it('should correctly obfuscate and deobfuscate Uint8Array', () => {
      ...
      const secureString = new SecureString(testArray);
      expect(secureString.valueAsUint8Array).toEqual(testArray);
    });
    ...
    it('should handle Uint8Array checksum validation', () => {
      ...
      expect(() => secureString.valueAsUint8Array).toThrow(SecureStorageError);
      try {
        void secureString.valueAsUint8Array;
      } catch (e) {
