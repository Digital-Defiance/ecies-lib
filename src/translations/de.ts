/**
 * German translations for ECIES library error messages and strings.
 */
...
export const germanTranslations: Record<EciesStringKey, string | PluralString> =
  {
    ...
    [EciesStringKey.Error_ECIESError_InvalidEncryptionTypeTemplate]:
      'Ungültiger Verschlüsselungstyp: {encryptionType}',
    ...
    [EciesStringKey.Error_ECIESError_InvalidIV]:
      'Ungültiger Initialisierungsvektor (IV)',
    ...
    [EciesStringKey.Error_ECIESError_InvalidSharedSecret]:
      'Ungültiges gemeinsames Geheimnis',
    [EciesStringKey.Error_ECIESError_InvalidPublicKeyNotOnCurve]:
      'Ungültiger öffentlicher Schlüssel: nicht auf der Kurve',
    [EciesStringKey.Error_ECIESError_InvalidAESKeyLength]:
      'Ungültige AES-Schlüssellänge: muss 16, 24 oder 32 Bytes sein',
    [EciesStringKey.Error_ECIESError_CannotEncryptEmptyData]:
      'Leere Daten können nicht verschlüsselt werden',
    [EciesStringKey.Error_ECIESError_CannotDecryptEmptyData]:
      'Leere Daten können nicht entschlüsselt werden',
    [EciesStringKey.Error_ECIESError_EncryptedSizeExceedsExpected]:
      'Verschlüsselte Größe überschreitet das erwartete Maximum',
    ...
    [EciesStringKey.Error_ECIESError_CannotOverwriteDefaultConfiguration]:
      'Die Standardkonfiguration kann nicht überschrieben werden',
    ...
    [EciesStringKey.Error_ECIESError_InvalidVersionTemplate]:
      'Ungültige ECIES-Version: {version}',
    [EciesStringKey.Error_ECIESError_InvalidCipherSuite]:
      'Ungültige ECIES-Verschlüsselungssuite',
    [EciesStringKey.Error_ECIESError_InvalidCipherSuiteTemplate]:
      'Ungültige ECIES-Verschlüsselungssuite: {cipherSuite}',
    ...
    [EciesStringKey.Error_InvalidEmailError_Whitespace]:
      'E-Mail-Adresse enthält führende oder nachfolgende Leerzeichen.',
    ...
    [EciesStringKey.Error_Stream_BufferOverflowTemplate]:
      'Pufferüberlauf: Quellblock überschreitet {max} Bytes',
    ...
    [EciesStringKey.Error_Stream_InvalidRecipientIdLengthTemplate]:
      'Ungültige Empfänger-ID: muss {expected} Bytes sein',
    ...
    [EciesStringKey.Error_Stream_ChunkSequenceErrorTemplate]:
      'Block-Sequenzfehler: erwartet {expected}, erhalten {actual}',
    ...
    [EciesStringKey.Error_Service_ComputedDecryptedLengthNegative]:
      'Berechnete entschlüsselte Länge ist negativ',
    [EciesStringKey.Error_Service_MultiRecipientNotImplemented]:
      'Multi-Empfänger-Verschlüsselung noch nicht implementiert',
    [EciesStringKey.Error_Service_InvalidEncryptionTypeOrRecipientCountTemplate]:
      'Ungültiger Verschlüsselungstyp oder Empfängeranzahl: {encryptionType}, {recipientCount}',
    [EciesStringKey.Error_Container_ServiceNotFoundTemplate]:
      'Service {service} nicht im Container gefunden',
    ...
    [EciesStringKey.Error_Invariant_ConfigurationValidationFailedMultipleTemplate]:
      createPluralString({
        ...
        other:
          'Konfigurationsvalidierung fehlgeschlagen ({count} Invarianten):\n\n{failures}',
      }),
  };
