/**
 * Spanish translations for ECIES library error messages and strings.
 */
import { createPluralString, PluralString } from '@digitaldefiance/i18n-lib';
import { EciesStringKey } from '../enumerations';

export const spanishTranslations: Record<
  EciesStringKey,
  string | PluralString
> = {
  ...
  [EciesStringKey.Error_ECIESError_InvalidEncryptionTypeTemplate]:
    'Tipo de cifrado no válido: {encryptionType}',
  ...
  [EciesStringKey.Error_ECIESError_FailedToDecryptKey]:
    'Error al descifrar la clave',
  [EciesStringKey.Error_ECIESError_TooManyRecipientsTemplate]:
    'Demasiados destinatarios: {recipientsCount}',
  ...
  [EciesStringKey.Error_ECIESError_InvalidChecksumConstants]:
    'Constantes de suma de control no válidas',
  [EciesStringKey.Error_ECIESError_CannotOverwriteDefaultConfiguration]:
    'No se puede sobrescribir la configuración predeterminada.',
  ...
  [EciesStringKey.Error_Service_ComputedDecryptedLengthNegative]:
    'La longitud descifrada calculada es negativa',
  [EciesStringKey.Error_Service_MultiRecipientNotImplemented]:
    'Cifrado multi-destinatario aún no implementado',
  [EciesStringKey.Error_Service_InvalidEncryptionTypeOrRecipientCountTemplate]:
    'Tipo de cifrado o número de destinatarios no válido: {encryptionType}, {recipientCount}',
  [EciesStringKey.Error_Container_ServiceNotFoundTemplate]:
    'Servicio {service} no encontrado en el contenedor',
  ...
  [EciesStringKey.Error_IdProviderError_InvalidLength]:
    'Longitud de ID incorrecta: se esperaban {expected} bytes, se recibieron {actual} en {context}',
  ...
  [EciesStringKey.Error_IdProviderError_InvalidStringLength]:
    'Longitud de cadena no válida: se esperaban {expected} caracteres, se recibieron {actual}',
  ...
  [EciesStringKey.Error_Invariant_ConfigurationValidationFailedMultipleTemplate]:
    createPluralString({
      ...
      other:
        'Validación de configuración falló ({count} invariantes):\n\n{failures}',
    }),
};
