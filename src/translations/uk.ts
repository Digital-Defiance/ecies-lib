...
export const ukrainianTranslations: Record<EciesStringKey, string | PluralString> = {
    ...
    [EciesStringKey.Error_ECIESError_MessageTooLarge]: 'Повідомлення занадто велике',
    ...
    [EciesStringKey.Error_MultiRecipient_InvalidRecipientCountTemplate]: 'Недійсна кількість одержувачів: {count}',
    [EciesStringKey.Error_MultiRecipient_SymmetricKeyMust32Bytes]: 'Симетричний ключ повинен бути 32 байти',
    [EciesStringKey.Error_MultiRecipient_InvalidChunkIndexTemplate]: 'Недійсний індекс блоку: {index}',
    [EciesStringKey.Error_MultiRecipient_DataSizeExceedsMaximumTemplate]: 'Розмір даних перевищує максимум: {size}',
    [EciesStringKey.Error_MultiRecipient_DuplicateRecipientId]: 'Виявлено дублікат ID одержувача',
    [EciesStringKey.Error_MultiRecipient_RecipientIdMust32Bytes]: 'ID одержувача повинен бути 32 байти',
    [EciesStringKey.Error_MultiRecipient_RecipientHeadersSizeOverflow]: 'Переповнення розміру заголовків одержувачів',
    [EciesStringKey.Error_MultiRecipient_ChunkSizeOverflow]: 'Переповнення розміру блоку: занадто багато одержувачів або дані занадто великі',
    [EciesStringKey.Error_MultiRecipient_ChunkTooSmall]: 'Блок занадто малий',
    [EciesStringKey.Error_MultiRecipient_InvalidChunkMagic]: 'Недійсне магічне число блоку з кількома одержувачами',
    [EciesStringKey.Error_MultiRecipient_UnsupportedVersionTemplate]: 'Непідтримувана версія: {version}',
    [EciesStringKey.Error_MultiRecipient_ChunkTooSmallForEncryptedSize]: 'Блок занадто малий для заявленого зашифрованого розміру',
    [EciesStringKey.Error_MultiRecipient_ChunkTruncatedRecipientId]: 'Блок обрізано: недостатньо даних для ID одержувача',
    [EciesStringKey.Error_MultiRecipient_ChunkTruncatedKeySize]: 'Блок обрізано: недостатньо даних для розміру ключа',
    [EciesStringKey.Error_MultiRecipient_InvalidKeySizeTemplate]: 'Недійсний розмір ключа: {size}',
    [EciesStringKey.Error_MultiRecipient_ChunkTruncatedEncryptedKey]: 'Блок обрізано: недостатньо даних для зашифрованого ключа',
    [EciesStringKey.Error_MultiRecipient_RecipientNotFoundInChunk]: 'Одержувача не знайдено в блоці',
    [EciesStringKey.Error_Stream_DataTooShortForHeader]: 'Дані занадто короткі для заголовка потоку',
    [EciesStringKey.Error_Stream_InvalidMagicBytes]: 'Недійсні магічні байти потоку',
    [EciesStringKey.Error_Stream_UnsupportedVersion]: 'Непідтримувана версія потоку',
    [EciesStringKey.Error_Stream_InvalidPublicKeyLength]: 'Недійсний відкритий ключ: повинен бути 33 (стиснутий) або 65 (нестиснутий) байти',
    [EciesStringKey.Error_Stream_BufferOverflowTemplate]: 'Переповнення буфера: вихідний блок перевищує {max} байти',
    [EciesStringKey.Error_Stream_EncryptionCancelled]: 'Шифрування скасовано',
    [EciesStringKey.Error_Stream_AtLeastOneRecipientRequired]: 'Потрібен щонайменше один одержувач',
    ...
    [EciesStringKey.Error_Chunk_DataTooShortForHeader]: 'Дані занадто короткі для заголовка фрагмента',
    [EciesStringKey.Error_Chunk_InvalidMagicBytes]: 'Недійсні магічні байти фрагмента',
    [EciesStringKey.Error_Chunk_UnsupportedVersion]: 'Непідтримувана версія фрагмента',
    [EciesStringKey.Error_Chunk_EncryptedSizeMismatchTemplate]: 'Невідповідність зашифрованого розміру: очікувано {expectedSize}, отримано {actualSize}',
    [EciesStringKey.Error_Chunk_ChecksumMismatch]: 'Невідповідність контрольної суми фрагмента',
    [EciesStringKey.Error_Chunk_DecryptedSizeMismatch]: 'Невідповідність розшифрованого розміру',
    [EciesStringKey.Error_Progress_ChunkBytesCannotBeNegative]: 'Байти фрагмента не можуть бути від’ємними',
    [EciesStringKey.Error_Resumable_AutoSaveIntervalMustBePositive]: 'Інтервал автозбереження повинен бути додатним',
    [EciesStringKey.Error_Resumable_PublicKeyMismatch]: 'Публічний ключ не відповідає збереженому стану',
    [EciesStringKey.Error_Resumable_ChunkSizeMismatch]: 'Розмір фрагмента не відповідає збереженому стану',
    [EciesStringKey.Error_Resumable_IncludeChecksumsMismatch]: 'Включення контрольних сум не відповідає збереженому стану',
    [EciesStringKey.Error_Resumable_NoStateToSave]: 'Немає стану для збереження',
    [EciesStringKey.Error_Resumable_UnsupportedStateVersionTemplate]: 'Непідтримувана версія стану: {version}',
    [EciesStringKey.Error_Resumable_InvalidChunkIndex]: 'Недійсний індекс фрагмента',
    [EciesStringKey.Error_Resumable_StateTooOld]: 'Стан занадто старий (>24 години)',
    [EciesStringKey.Error_Resumable_InvalidPublicKeyInState]: 'Недійсний публічний ключ у стані',
    [EciesStringKey.Error_Resumable_StateIntegrityCheckFailed]: 'Перевірка цілісності стану не вдалася: HMAC не відповідає',
    [EciesStringKey.Error_Builder_MnemonicGenerationNotImplemented]: 'Генерація мнемоніки ще не реалізована в v2',
    [EciesStringKey.Error_Builder_MemberNotMigrated]: 'Член ще не перенесено до v2',
    [EciesStringKey.Error_Builder_ECIESServiceNotMigrated]: 'ECIESService ще не перенесено до v2',
    [EciesStringKey.Error_Service_InvalidDataLength]: 'Недійсна довжина даних',
    [EciesStringKey.Error_Service_InvalidEncryptionType]: 'Недійсний тип шифрування',
    [EciesStringKey.Error_Service_InvalidEncryptedDataLength]: 'Недійсна довжина зашифрованих даних',
    [EciesStringKey.Error_Service_ComputedDecryptedLengthNegative]: 'Обчислена довжина розшифрованих даних є від’ємною',
    [EciesStringKey.Error_Service_MultiRecipientNotImplemented]: 'Шифрування для кількох одержувачів ще не реалізовано',
    [EciesStringKey.Error_Service_InvalidEncryptionTypeOrRecipientCountTemplate]: 'Недійсний тип шифрування або кількість одержувачів: {encryptionType}, {recipientCount}',
    [EciesStringKey.Error_Container_ServiceNotFoundTemplate]: 'Сервіс {service} не знайдено в контейнері',
    [EciesStringKey.Error_Utils_InvalidHexString]: 'Недійсний шістнадцятковий рядок',
    [EciesStringKey.Error_Utils_HexStringMustHaveEvenLength]: 'Шістнадцятковий рядок повинен мати парну довжину',
    [EciesStringKey.Error_Utils_HexStringContainsInvalidCharacters]: 'Шістнадцятковий рядок містить недійсні символи',
