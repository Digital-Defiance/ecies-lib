...
export const frenchTranslations: Record<EciesStringKey, string | PluralString> = {
    ...
    [EciesStringKey.Error_ECIESError_MessageTooLarge]: 'Message trop volumineux',
    ...
    [EciesStringKey.Error_MultiRecipient_InvalidRecipientCountTemplate]: 'Nombre de destinataires invalide : {count}',
    [EciesStringKey.Error_MultiRecipient_SymmetricKeyMust32Bytes]: 'La clé symétrique doit faire 32 octets',
    [EciesStringKey.Error_MultiRecipient_InvalidChunkIndexTemplate]: 'Index de bloc invalide : {index}',
    [EciesStringKey.Error_MultiRecipient_DataSizeExceedsMaximumTemplate]: 'La taille des données dépasse le maximum : {size}',
    [EciesStringKey.Error_MultiRecipient_DuplicateRecipientId]: 'ID de destinataire en double détecté',
    [EciesStringKey.Error_MultiRecipient_RecipientIdMust32Bytes]: 'L\'ID du destinataire doit faire 32 octets',
    [EciesStringKey.Error_MultiRecipient_RecipientHeadersSizeOverflow]: 'Débordement de la taille des en-têtes de destinataires',
    [EciesStringKey.Error_MultiRecipient_ChunkSizeOverflow]: 'Débordement de la taille du bloc : trop de destinataires ou données trop volumineuses',
    [EciesStringKey.Error_MultiRecipient_ChunkTooSmall]: 'Bloc trop petit',
    [EciesStringKey.Error_MultiRecipient_InvalidChunkMagic]: 'Nombre magique de bloc multi-destinataires invalide',
    [EciesStringKey.Error_MultiRecipient_UnsupportedVersionTemplate]: 'Version non prise en charge : {version}',
    [EciesStringKey.Error_MultiRecipient_ChunkTooSmallForEncryptedSize]: 'Bloc trop petit pour la taille chiffrée déclarée',
    [EciesStringKey.Error_MultiRecipient_ChunkTruncatedRecipientId]: 'Bloc tronqué : pas assez de données pour l\'ID du destinataire',
    [EciesStringKey.Error_MultiRecipient_ChunkTruncatedKeySize]: 'Bloc tronqué : pas assez de données pour la taille de la clé',
    [EciesStringKey.Error_MultiRecipient_InvalidKeySizeTemplate]: 'Taille de clé invalide : {size}',
    [EciesStringKey.Error_MultiRecipient_ChunkTruncatedEncryptedKey]: 'Bloc tronqué : pas assez de données pour la clé chiffrée',
    [EciesStringKey.Error_MultiRecipient_RecipientNotFoundInChunk]: 'Destinataire introuvable dans le bloc',
    [EciesStringKey.Error_Stream_DataTooShortForHeader]: 'Données trop courtes pour l\'en-tête de flux',
    [EciesStringKey.Error_Stream_InvalidMagicBytes]: 'Octets magiques de flux invalides',
    [EciesStringKey.Error_Stream_UnsupportedVersion]: 'Version de flux non prise en charge',
    [EciesStringKey.Error_Stream_InvalidPublicKeyLength]: 'Clé publique invalide : doit faire 33 (compressée) ou 65 (non compressée) octets',
    [EciesStringKey.Error_Stream_BufferOverflowTemplate]: 'Débordement de tampon : le bloc source dépasse {max} octets',
    ...
    [EciesStringKey.Error_Chunk_DataTooShortForHeader]: 'Données trop courtes pour l\'en-tête du bloc',
    [EciesStringKey.Error_Chunk_InvalidMagicBytes]: 'Octets magiques du bloc invalides',
    [EciesStringKey.Error_Chunk_UnsupportedVersion]: 'Version du bloc non prise en charge',
    [EciesStringKey.Error_Chunk_EncryptedSizeMismatchTemplate]: 'Taille chiffrée incompatible : attendu {expectedSize}, obtenu {actualSize}',
    [EciesStringKey.Error_Chunk_ChecksumMismatch]: 'Somme de contrôle du bloc incompatible',
    [EciesStringKey.Error_Chunk_DecryptedSizeMismatch]: 'Taille déchiffrée incompatible',
    [EciesStringKey.Error_Progress_ChunkBytesCannotBeNegative]: 'Les octets du bloc ne peuvent pas être négatifs',
    [EciesStringKey.Error_Resumable_AutoSaveIntervalMustBePositive]: 'L\'intervalle de sauvegarde automatique doit être positif',
    [EciesStringKey.Error_Resumable_PublicKeyMismatch]: 'Clé publique incompatible avec l\'état sauvegardé',
    [EciesStringKey.Error_Resumable_ChunkSizeMismatch]: 'Taille du bloc incompatible avec l\'état sauvegardé',
    [EciesStringKey.Error_Resumable_IncludeChecksumsMismatch]: 'Inclusion des sommes de contrôle incompatible avec l\'état sauvegardé',
    [EciesStringKey.Error_Resumable_NoStateToSave]: 'Aucun état à sauvegarder',
    [EciesStringKey.Error_Resumable_UnsupportedStateVersionTemplate]: 'Version d\'état non prise en charge : {version}',
    [EciesStringKey.Error_Resumable_InvalidChunkIndex]: 'Index de bloc invalide',
    [EciesStringKey.Error_Resumable_StateTooOld]: 'État trop ancien (>24 heures)',
    [EciesStringKey.Error_Resumable_InvalidPublicKeyInState]: 'Clé publique invalide dans l\'état',
    [EciesStringKey.Error_Resumable_StateIntegrityCheckFailed]: 'Échec de la vérification de l\'intégrité de l\'état : HMAC incompatible',
    [EciesStringKey.Error_Builder_MnemonicGenerationNotImplemented]: 'Génération de mnémonique pas encore implémentée dans v2',
    [EciesStringKey.Error_Builder_MemberNotMigrated]: 'Membre pas encore migré vers v2',
    [EciesStringKey.Error_Builder_ECIESServiceNotMigrated]: 'ECIESService pas encore migré vers v2',
    [EciesStringKey.Error_Service_InvalidDataLength]: 'Longueur de données invalide',
    [EciesStringKey.Error_Service_InvalidEncryptionType]: 'Type de chiffrement invalide',
    [EciesStringKey.Error_Service_InvalidEncryptedDataLength]: 'Longueur de données chiffrées invalide',
    [EciesStringKey.Error_Service_ComputedDecryptedLengthNegative]: 'La longueur déchiffrée calculée est négative',
    [EciesStringKey.Error_Service_MultiRecipientNotImplemented]: 'Chiffrement multi-destinataires pas encore implémenté',
    [EciesStringKey.Error_Service_InvalidEncryptionTypeOrRecipientCountTemplate]: 'Type de chiffrement ou nombre de destinataires invalide : {encryptionType}, {recipientCount}',
    [EciesStringKey.Error_Container_ServiceNotFoundTemplate]: 'Service {service} introuvable dans le conteneur',
    [EciesStringKey.Error_Utils_InvalidHexString]: 'Chaîne hexadécimale invalide',
    [EciesStringKey.Error_Utils_HexStringMustHaveEvenLength]: 'La chaîne hexadécimale doit avoir une longueur paire',
    [EciesStringKey.Error_Utils_HexStringContainsInvalidCharacters]: 'La chaîne hexadécimale contient des caractères invalides',
    [EciesStringKey.Error_Utils_ValueExceedsSafeIntegerRange]: 'La valeur dépasse la plage d\'entiers sûrs',
    [EciesStringKey.Error_Utils_ValueBelowSafeIntegerRange]: 'La valeur est inférieure à la plage d\'entiers sûrs',
